...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;CACC,yBAAyB;CACzB,aAAa;CACb,sBAAsB;CACtB,SAAS;AACV;;AAEA;CACC,aAAa;CACb,YAAY;AACb;;AAEA;CACC,YAAY;CACZ,kBAAkB;CAClB,QAAQ;CACR,2BAA2B;CAC3B,WAAW;CACX,UAAU;CACV,sBAAsB;AACvB","sourcesContent":["body {\n\tbackground-color: skyblue;\n\tdisplay: flex;\n\tflex-direction: column;\n\tgap: 20px;\n}\n\n#pokeimage {\n\theight: 200px;\n\twidth: 200px;\n}\n\n.pokedex {\n\tmargin: auto;\n\tposition: relative;\n\ttop: 50%;\n\ttransform: translateY(-50%);\n\theight: 80%;\n\twidth: 60%;\n\tborder: 4px groove red;\n}\n"],"sourceRoot":""}]);
// Exports
